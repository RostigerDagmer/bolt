...
pub struct DescriptorSetInfo {
    pub buffer_infos: BTreeMap<u32, Vec<vk::DescriptorBufferInfo>>,
    pub image_infos: BTreeMap<u32, Vec<vk::DescriptorImageInfo>>,
    pub acceleration_structures: BTreeMap<u32, Vec<vk::AccelerationStructureKHR>>,
}
...
impl PartialOrd for DescriptorSetInfo {
...
impl Ord for DescriptorSetInfo {
...
impl DescriptorSetInfo {
    ...
    // TODO: properly overload the image function
    pub fn image_opt(mut self, binding: u32, image: &Option<crate::Texture2d>) -> Self {
        if let Some(image) = image {
            self.image_infos.insert(binding, vec![image.get_descriptor_info()]);
        }
        self
    }
...
pub struct DescriptorSetLayoutInfo {
    pub bindings: BTreeMap<u32, (vk::DescriptorType, vk::ShaderStageFlags, u32)>,
...
pub struct DescriptorSetLayout {
    ...
    sets: std::collections::HashMap<DescriptorSetInfo, DescriptorSet>,
}
...
impl DescriptorSetLayout {
    pub fn new(context: Arc<Context>, info: DescriptorSetLayoutInfo) -> Self {
        ...
        unsafe {
            ...
            DescriptorSetLayout {
                ...
                pool,
                info: info,
                sets: std::collections::HashMap::<DescriptorSetInfo, DescriptorSet>::new(),
            }
        }
    }
    ...
    pub fn get_or_create(&mut self, info: DescriptorSetInfo) -> DescriptorSet {
        ...
        println!("buffer infos {:?}", info.buffer_infos);
        // println!("self.sets {:?}", self.sets);
        unsafe {
    ...
    pub fn get_descriptor_type(&self, binding: u32) -> vk::DescriptorType {
        println!("looking up type of {:?} -> {:?}", binding, self.info.bindings[&binding].0);
