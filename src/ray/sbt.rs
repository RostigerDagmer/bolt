...
impl ShaderBindingTable {
    pub fn new(context: Arc<Context>,  pipeline: vk::Pipeline, info: ShaderBindingTableInfo) -> Self {
        ...
        println!("group_handles_size: {}", group_handles_size);
        println!("shader_group_handle_size: {}", shader_group_handle_size);
        println!("group_count: {}", group_count);
        println!("group_handles: {:?}", group_handles);
